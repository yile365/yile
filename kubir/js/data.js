...
// var DELAY_MUL = 0;
// var MIX_DELAY = 0;
var MAX_DISCOVER = 80;//最大探索度 

var BIG_BOX_BASE_SIZE = 32;
var BAG_BASE_SIZE = 24;
...
var STATE_DATA = {
    ...
    full:{
        name:'满腹',
        desc:'饮食是冒险者们头疼的问题。随着时间的流逝会感到饥锇。',
    },
    moist:{
        name:'水分',
        desc:'水乃万物之源，人体水分会随着时间流逝而流失。脱水意味死亡。',
    },
    hp:{
        name:'生命',
    ...
    ps:{
        name:'体能',
        desc:'野外采集会消耗体力，睡觉是恢复体力最佳方法。体能影响你的战斗力。',
    },
    san:{
        name:'精神',
        desc:'精神影响着你的战斗命中率。在外熬夜或者状态低下均容易造成精神萎靡。',
    },
}
var COOK_DATA = [
...
var SKILL_DATA = {
    ...
    blood:{
        name:'嗜血',
        desc:'当你获得胜利时，将恢复30%的生命。',
        buff:0.3,
        one:true,
    },
    absorb:{
        name:'吸收',
        desc:'当你获得胜利时，将恢复30%的精神。',
        buff:0.3,
        one:true,
    },
    melee:{
    ...
    farm:{
        name:'耕种技巧',
        desc:'每一级使你的农作物额外获得30%的产量。',
        buff:0.3,
    },
    alco:{
        name:'酿酒技巧',
        desc:'每一级使你的酿酒额外获得40%的产量。',
        buff:0.4,
    },
    magic:{
        name:'魔法技巧',
